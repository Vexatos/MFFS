...
/**
 * GUI Container for the Force Energy Capacitor.
 */
class GUIFECapacitor(tileEntity: TileEntityFECapacitor, playerInventory: InventoryPlayer)
	extends GuiContainer(new ContainerFECapacitor(tileEntity, playerInventory)) {
