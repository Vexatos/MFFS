...
/**
 * Container behind the Force Energy Capacitor.
 */
class ContainerFECapacitor(tileEntity: TileEntityFECapacitor, playerInventory: InventoryPlayer) extends Container {
	final val SLOT_POWER_LINK = 0
